<x-layout.layout>
    ...
    <div class="p-4">
        <div class="flex flex-row justify-between items-center mb-4">
            <h1 class="text-[16px] font-medium text-gray-800">Add Incident Reports</h1>
        </div>
        <hr class="mb-6 border-gray-300">

        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- 🧾 Left Column: Form -->
            <form action="{{ route('operation-officer.submit-report') }}" method="POST" id="incidentForm" class="space-y-4 bg-white p-6 rounded-xl shadow-md border border-gray-200">
                @csrf
            ...
            <div class="bg-white p-4 rounded-xl shadow-md border border-gray-200">
                ...
                <div id="map" style="height: 520px;" class="z-0 rounded-lg border"></div>
            </div>
        </div>
    </div>
    <x-partials.stack-js />
